...
export const slashCommands = [
  ...
  },
  {
    ...
    category: "text",
    keywords: ["heading", "h6"],
    command: (e) => e.chain().focus().toggleHeading({ level: 6 }).run(),
  },
  {
    id: "bulletList",
    title: "Bullet List",
  ...
  // Media
  {
    ...
    command: (e) => e.chain().focus().insertContent({ type: "blockImage" }).run(),
  },
  {
    id: "video",
    title: "Video",
    ...
    command: (e) => e.chain().focus().insertContent({ type: "blockVideo" }).run(),
  },
  {
    id: "youtube",
    title: "YouTube",
    description: "Embed a YouTube video",
    icon: <span className="text-[11px] font-bold text-red-500">YT</span>,
    category: "media",
  ...
  },
  {
    ...
    command: (e) => e.chain().focus().insertContent({ type: "blockPDF" }).run(),
  },
  {
    id: "audio",
    title: "Audio",
    ...
    command: (e) => e.chain().focus().insertContent({ type: "blockAudio" }).run(),
  },
  ...
  // Interactive
  {
    id: "magicBlock",
    title: "Magic Block",
    description: "AI-powered interactive content",
    icon: <span className="text-xs font-bold text-purple-400">AI</span>,
    category: "interactive",
    keywords: ["magic", "ai", "interactive", "generate"],
  ...
  },
  {
    ...
    command: (e) => e.chain().focus().insertContent({ type: "blockQuiz" }).run(),
  },
  {
    id: "mathEquation",
    title: "Math Equation",
    ...
    command: (e) => e.chain().focus().insertContent({ type: "blockMathEquation" }).run(),
  },
  {
    id: "webPreview",
    title: "Web Preview",
    ...
    command: (e) => e.chain().focus().insertContent({ type: "blockWebPreview" }).run(),
  },
  {
    id: "flipcard",
    title: "Flipcard",
    ...
    category: "interactive",
    keywords: ["flipcard", "flashcard", "card", "memory"],
    command: (e) =>
      e
        .chain()
        .focus()
  ...
  },
  {
    ...
    category: "interactive",
    keywords: ["code", "playground", "coding", "challenge", "execute", "run"],
    command: (e) =>
      e
        .chain()
        .focus()
        ...
        .insertContent({
          ...
          attrs: {
            ...
            scenarios: [
              ...
              {
                id: "2",
                text: "Great choice! You are now exploring further.",
                imageUrl: "",
                options: [
              ...
              {
                id: "3",
                text: "Here's more information about the topic.",
                imageUrl: "",
                options: [
  ...
  // Callouts
  {
    ...
    command: (e) =>
      e
        .chain()
        .focus()
        .insertContent({ type: "callout", attrs: { type: "info" }, content: [] })
        .run(),
  },
  ...
  // UI Elements
  {
    ...
    command: (e) =>
      e
        .chain()
        .focus()
        .insertContent({ type: "badge", content: [{ type: "text", text: "This is a Badge" }] })
        .run(),
  },
  {
    id: "button",
    ...
    command: (e) =>
      e
        .chain()
        .focus()
        .insertContent({ type: "button", content: [{ type: "text", text: "Click me" }] })
        .run(),
  },
  {
    id: "user",
    ...
    command: (e) => e.chain().focus().insertContent({ type: "blockUser" }).run(),
  },
  {
    id: "embed",
    title: "Embed",
