              ...
              {isEditing ? (
                <>
                  <button
                    ...
                    className="flex items-center gap-1.5 rounded-lg bg-blue-600 px-3 py-1.5 text-xs font-medium text-white transition-colors outline-none"
                  >
                    <Play size={12} />
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 rounded-lg bg-neutral-700 px-3 py-1.5 text-xs font-medium text-white transition-colors outline-none"
                  >
                    <Save size={12} />
                    Done
                  </button>
                ...
                <div className="flex items-center justify-between border-b border-neutral-200 bg-neutral-50 px-4 py-2">
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      ...
                      className={`rounded px-2 py-1 text-xs font-medium ${scenario.id === currentScenarioId ? "bg-emerald-500 text-white" : "bg-neutral-200 text-neutral-700 hover:bg-neutral-300"}`}
                    >
            ...
            return previewCurrentId === "end" ? (
              <div className="nice-shadow rounded-lg bg-white p-6 text-center">
                ...
                <button
                  ...
                  className="rounded-lg bg-neutral-700 px-4 py-2 text-sm text-white"
                >
        ...
        {(!isEditable || !isEditing) &&
          (isEditable ? (
            ...
            <div className="nice-shadow rounded-lg bg-white p-6 text-center">
              ...
              <button
                onClick={resetScenario}
                className="inline-flex items-center gap-2 rounded-lg bg-neutral-700 px-4 py-2 text-sm font-medium text-white hover:bg-neutral-800"
              >
                <RotateCcw size={16} />
                Start Over
              </button>
