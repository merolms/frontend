...
export default Node.create({
  ...
  parseHTML() { return [{ tag: 'scenarios-block' }] },
  renderHTML({ HTMLAttributes }) { return ['scenarios-block', mergeAttributes(HTMLAttributes)] },
  addNodeView() { return ReactNodeViewRenderer(ScenariosExtension) },
})
