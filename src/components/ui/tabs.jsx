...
const Tabs = ({ defaultValue, value, onValueChange, children, className }) => {
  ...
  const setCurrent = (v) => { if (value === undefined) setInternalVal(v); if (onValueChange) onValueChange(v); };
  return (
...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <div ref={ref} className={cn('flex items-center gap-1 rounded-lg border border-border p-1', className)} {...props} />
));
