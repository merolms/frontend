  ...
  useEffect(() => {
    const loadRoles = async () => {
      try {
        ...
        setRoleOptions([{ value: 'all', label: 'All Roles' }, ...roles.map((r) => ({ value: r.name, label: r.name }))]);
      ...
      >
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center">
            <p className="text-text-secondary text-sm">No users found. Try adjusting your filters or add a new user.</p>
