...
import { mockCreateCourse } from '@/app/services/courseService';
          ...
          <Grid stackable>
            <Grid.Column width={10}>
              <Segment className='course-form-card'>
                ...
                <CreateCourseForm onSubmit={handleSubmit} onCancel={handleCancel} />
              </Segment>
            </Grid.Column>
...
// ─── Create-specific form (includes cover image preview) ────
