...
function CreateLesson() {
  ...
  return (
    <>
      <Button variant="subtle" onClick={() => setOpen(true)}>Create Lesson</Button>
      <Modal opened={open} onClose={() => setOpen(false)} title="Create Lesson" size="lg" closeOnClickOutside={false}>
        <Stack>
          <TextInput label="Title" placeholder="Enter a title name" required />
          <Textarea label="Description" placeholder="Tell something about this lesson" minRows={4} />
        </Stack>
