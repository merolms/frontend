          ...
          {lessons.length > 0 && (
            ...
            >
              {selectedIds.size === lessons.length && (
                <svg style={{ width: 10, height: 10, color: t("bg-surface") }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {isSelected && (
            <svg style={{ width: 9, height: 9, color: t("bg-surface") }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
            </svg>
          )}
        </button>
