...
let mockEvents = [
  ...
  },
  {
    ...
    description: 'Bring your designs for peer review and expert feedback from industry professionals.',
    type: 'review',
    color: '#EC4899',
  ...
  },
  {
    ...
    description: 'Hands-on workshop covering Kubernetes architecture, deployment strategies, and monitoring.',
    type: 'workshop',
    color: '#06B6D4',
...
export const fetchEvents = async (params = {}) => {
  ...
  if (params.search) {
    ...
    results = results.filter((e) =>
      ...
      (e.instructor || '').toLowerCase().includes(q) || e.tags.some((t) => t.includes(q))
    );
  }
...
export const updateEvent = async (id, data) => {
  ...
  mockEvents[index] = { ...mockEvents[index], ...data, updatedAt: new Date().toISOString().split('T')[0] };
