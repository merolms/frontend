...
export const storeAuth = (user: any, token: string) => {
...
const normalizeRolePermissions = (role: any) => {
  if (!role) return role;
  return {
    ...role,
...
export const hasAllPermissions = (user: any, permissions: string[]) => {
  return permissions.every((p) => hasPermission(user, p));
};

export const hasAnyPermission = (user: any, permissions: string[]) => {
...
export const mockUpdateUser = async (userId: number, updates: any) => {
