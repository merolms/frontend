...
const MOCK_RESPONSES = {
  greeting:
    "Hello! I'm your MeroEdu AI assistant. I can help you with courses, learning paths, and platform questions. How can I help you today?",
...
const getMockResponse = (userText: string): string => {
  ...
  if (lower.includes("course") || lower.includes("learn") || lower.includes("class"))
    return MOCK_RESPONSES.course;
