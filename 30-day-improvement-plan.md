      ...
      return (
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <button onClick={() => window.location.reload()} className="px-4 py-2 bg-primary text-white rounded">Reload Page</button>
          </div>
        </div>
      );
    }
...
const sanitizeContent = (html) => DOMPurify.sanitize(html, { ALLOWED_TAGS: ['p', 'h1', 'h2', 'ul', 'ol', 'li', 'a', 'img'] });
