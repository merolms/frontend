            ...
            <ul className="text-text-muted space-y-1 text-xs">
              {warnings.lessons && (
                <li className="flex items-center gap-2">
                  <span>•</span>
                  <span>
                    {warnings.lessons} lesson{warnings.lessons === 1 ? "" : "s"}
                  </span>
                </li>
              )}
              {warnings.enrolled && (
                <li className="flex items-center gap-2">
                  <span>•</span>
                  <span>
                    {warnings.enrolled} enrolled user{warnings.enrolled === 1 ? "" : "s"}
                  </span>
                </li>
              )}
              {warnings.assignments && (
                <li className="flex items-center gap-2">
                  <span>•</span>
                  <span>
                    {warnings.assignments} assignment submission
                    {warnings.assignments === 1 ? "" : "s"}
                  </span>
                </li>
              )}
              {warnings.quizzes && (
                <li className="flex items-center gap-2">
                  <span>•</span>
                  <span>
                    {warnings.quizzes} quiz result{warnings.quizzes === 1 ? "" : "s"}
                  </span>
                </li>
              )}
              {warnings.members && (
                <li className="flex items-center gap-2">
                  <span>•</span>
                  <span>
                    {warnings.members} member{warnings.members === 1 ? "" : "s"}
                  </span>
                </li>
              )}
            </ul>
