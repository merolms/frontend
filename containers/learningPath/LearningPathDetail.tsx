...
const LearningPathDetail = ({ learningPathId }: LearningPathDetailProps) => {
  const router = useRouter();
  const { addToast } = useToast();

  const { data: path, isLoading, error } = useLearningPath(learningPathId);
    ...
    return (
      <DashboardLayout title="Learning Path" subtitle="Not found">
        <div className="flex flex-col items-center justify-center py-16">
          ...
          <Button size="sm" className="mt-4" onClick={() => router.push("/learning-paths")}>
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                variant="default"
                size="sm"
                onClick={() => router.push(`/learning-paths/${learningPathId}/edit`)}
              >
                <Edit size={14} /> Edit
              </Button>
