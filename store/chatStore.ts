...
const seedChannels = [
  ...
  },
  {
    ...
    name: "random",
    type: "channel",
    description: "Off-topic fun and chatter",
    unread: 0,
  },
  {
    id: "help",
    name: "help",
    type: "channel",
    description: "Ask for help with courses and platform",
    unread: 2,
  },
  {
    id: "announcements",
...
const seedMessages = {
  general: [
    ...
    },
    {
      id: "g3",
      userId: 3,
      text: "Has anyone tried the new React course? It's really well structured.",
    ...
    },
    {
      id: "g4",
      userId: 4,
      text: "Yes! I just finished the hooks section. The exercises are great.",
    ...
    },
    {
      id: "g5",
      userId: 2,
      text: "I'm planning to add more advanced content on state management soon.",
    ...
    },
    {
      id: "g6",
      userId: 1,
      text: "That would be awesome! Maybe cover Zustand and Jotai too?",
    ...
    },
    {
      id: "g7",
      userId: 3,
      text: "Also, the team lead meeting is tomorrow at 10 AM.",
  ...
  random: [
    {
      id: "r1",
      userId: 4,
      text: "Anyone up for a code challenge this weekend?",
    ...
    },
    {
      id: "r2",
      userId: 3,
      text: "Sure! What kind of challenge?",
    ...
    },
    {
      id: "r3",
      userId: 4,
      text: "Maybe a small project — like building a todo app with React hooks",
    ...
    },
    {
      id: "r4",
      userId: 2,
      text: "I'm in! Could be a good learning exercise.",
      timestamp: Date.now() - 3600000,
      reactions: {},
    },
  ],
  help: [
    ...
    },
    {
      id: "h2",
      userId: 2,
      text: "Go to the Courses page, find the course you want, and click \"Enroll Now\". If it's published, you'll get instant access!",
    ...
    },
    {
      id: "h3",
      userId: 4,
      text: "Thanks Jane! What if I want to unenroll?",
    ...
    },
    {
      id: "h4",
      userId: 2,
      text: "You can drop a course from the course detail page. Just be aware that your progress will be saved if you re-enroll later.",
  ...
  announcements: [
    {
      id: "a1",
      userId: 1,
      text: '📢 **New Course Available**: "Advanced JavaScript Patterns" is now live! Check it out in the courses section.',
    ...
    },
    {
      id: "a2",
      userId: 1,
      text: "📢 **Platform Update**: We've added team performance tracking. Team leads can now see detailed analytics.",
  ...
  engineering: [
    {
      id: "e1",
      userId: 2,
      text: "The new curriculum builder is ready for testing. Who wants to try it out?",
      timestamp: Date.now() - 1800000,
      reactions: {},
    },
    {
      id: "e2",
      userId: 3,
      text: "I'll test it! Send me the link.",
    ...
    },
    {
      id: "e3",
      userId: 1,
      text: "Great work on the drag-and-drop feature Jane! 🎉",
